...
# Stile della pagina
st.markdown(""" <style>     .metric-card {         border: 2px solid #4CAF50; /* Colore del bordo */         background-color: #F1F8E9; /* Colore dello sfondo */         border-radius: 10px; /* Angoli arrotondati */         padding: 10px; /* Padding interno */         margin: 10px 0; /* Spazio verticale intorno alla card */     }     .metric-title {         color: #333; /* Colore del testo del titolo */         font-size: 1.5em; /* Dimensione del testo del titolo */     }     .metric-value {         color: #000; /* Colore del testo del valore */         font-size: 2.5em; /* Dimensione del testo del valore */     } </style> """, unsafe_allow_html=True)
st.markdown(
    """<style>
...
st.write("")  # Questo può aggiungere spazio verticale
